...
namespace Collective\Html {
    ...
    /**
     * @see \Collective\Html\FormBuilder::date
     ...
     * @see \Collective\Html\FormBuilder::selectRange
     ...
     * @see \Collective\Html\Componentable::hasComponent
     * @method static bool hasComponent($name)
     * @see \Collective\Html\FormBuilder::open
     * @method static \Illuminate\Support\HtmlString open(array $options = [])
     */
    class FormFacade {}
    
    /**
     * @see \Collective\Html\HtmlBuilder::linkSecureAsset
     ...
     * @see \Collective\Html\HtmlBuilder::link
     ...
     * @see \Collective\Html\HtmlBuilder::dl
     * @method static \Illuminate\Support\HtmlString dl(array $list, array $attributes = [])
     * @see \Collective\Html\HtmlBuilder::linkAction
...
namespace Illuminate\Support\Facades {
    ...
    /**
     * @see \Illuminate\Http\Request::inertia
    ...
    /**
     * @see \Illuminate\Routing\Router::inertia
     * @method static \Illuminate\Routing\Route inertia($uri, $component, $props = [])
...
namespace Inertia {
     ...
     * @see \Illuminate\Support\Traits\Macroable::macro
     * @method static void macro(string $name, callable|object $macro)
     * @see \Inertia\ResponseFactory::lazy
     * @method static \Inertia\LazyProp lazy(callable $callback)
     * @see \Inertia\ResponseFactory::getVersion
     * @method static string getVersion()
     * @see \Inertia\ResponseFactory::getShared
     * @method static array getShared($key = null)
     * @see \Inertia\ResponseFactory::version
     * @method static void version($version)
     * @see \Illuminate\Support\Traits\Macroable::mixin
     * @method static void mixin(object $mixin, bool $replace = true)
     * @see \Illuminate\Support\Traits\Macroable::hasMacro
     * @method static bool hasMacro(string $name)
     * @see \Inertia\ResponseFactory::share
     * @method static void share($key, $value = null)
     * @see \Inertia\ResponseFactory::location
     * @method static void location($url)
     * @see \Inertia\ResponseFactory::setRootView
     * @method static void setRootView($name)
     * @see \Inertia\ResponseFactory::render
...
namespace Livewire {
     ...
     * @see \Livewire\LivewireManager::setBackButtonCache
     ...
     * @method static mixed|null getAlias($class, $default = null)
     ...
     * @see \Livewire\LivewireManager::enableBackButtonCache
     ...
     * @method static false|mixed getClass($alias)
     ...
     * @see \Livewire\LivewireManager::disableBackButtonCache
     * @method static void disableBackButtonCache()
     * @see \Livewire\LivewireManager::shouldDisableBackButtonCache
